                ...
                if ( Array.isArray( button ) ) {
                    ...
                    switch ( button ) {
                        ...
                        case 'previous':
                            ...
                            btnDisplay = `<dt class="the-icon"><span class="bi bi-chevron-left select-all "></span></dt>`;
                            btnClass = button + (page > 0 ?
                                '' : ' disabled');
                            break;
                        ...
                        case 'next':
                            ...
                            btnDisplay = `<dt class="the-icon"><span class="bi bi-chevron-right select-all "></span></dt>`;
